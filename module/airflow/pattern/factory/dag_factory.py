...
from module.airflow.handler.telegram_handler import telegram_success_callback, telegram_failure_callback
...
class PudataDagFactory:
    def __init__(
        ...
        self._on_failure_callback = telegram_failure_callback
    ...
    def description(self, desc: str) -> PudataDagFactory:
        self._description = desc

        return self

    def max_active_runs(self, run_cnt: int) -> PudataDagFactory:
        self._max_active_runs = run_cnt

        return self

    def max_active_tasks(self, task_cnt: int) -> PudataDagFactory:
        self._max_active_tasks = task_cnt

        return self

    def owner_links(self, owners: dict) -> PudataDagFactory:
        self._owner_links = owners

        return self

    def dagrun_timeout(self, time: timedelta) -> PudataDagFactory:
        self._dagrun_timeout = time

        return self

    def activate_success_callback(self) -> PudataDagFactory:
        self._on_success_callback = telegram_success_callback
